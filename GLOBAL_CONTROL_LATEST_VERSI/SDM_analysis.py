...
for SIMGA in [2]:
    for Kay in [1,2,3,5,8]:
        ...
        plt.savefig('Population_size_plot_K{}_Sig{}.pdf'.format(str(Kay),str(SIMGA)))
        ...
        plt.colorbar().ax.tick_params(labelsize=90) 
        plt.savefig('Distribution_plot_K{}_Sig{}.pdf'.format(str(Kay),str(SIMGA)))
        plt.close()
        ...
        plt.colorbar().ax.tick_params(labelsize=90) 
        plt.savefig('Fitness_Distribution_plot_K{}_Sig{}.pdf'.format(str(Kay),str(SIMGA)))
        plt.close()
        ...
        plt.colorbar().ax.tick_params(labelsize=90) 
        plt.savefig('Competition_Distribution_plot_K{}_Sig{}.pdf'.format(str(Kay),str(SIMGA)))
        plt.close()
        ...
        plt.colorbar().ax.tick_params(labelsize=90) 
        plt.savefig('Optimum_Distribution_plot_K{}_Sig{}.pdf'.format(str(Kay),str(SIMGA)))
        plt.close()
